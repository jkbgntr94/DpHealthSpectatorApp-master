...
{
    public class GameSceneFall : CCScene
    {
        CCDrawNode circle;
        CCDrawNode square;
        DatabaseContext _context;

        public GameSceneFall(CCGameView gameView) : base(gameView)
        {
        ...
        public GameSceneFall(CCGameView gameView, float x, float y) : base(gameView)
        {
            var layer = new CCLayer();
            this.AddLayer(layer);
            _context = new DatabaseContext();
